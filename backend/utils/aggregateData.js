...
export const aggregateData = (tmdbData, omdbData) => {
    ...
    return {
      poster: tmdbData.poster_path ? `https://image.tmdb.org/t/p/original${tmdbData.poster_path}` : null,
      ...
      trailers: tmdbData.videos ? tmdbData.videos.results.map(video => `https://www.youtube.com/watch?v=${video.key}`) : [],
