          ...
          {Array.from({ length: 9 }, (_, i) => {
            ...
            if (!isLoading) {
             ...
             if (currentPage < 5) {
               ...
               prevPageNumber = currentPage - offset + i;
             } 
              // else {
              //   let prevPageNumber;
              //   if (currentPage < 5) {
              ...
              return (
                <NumberButton
                  key={i}
                  onClick={() => setCurrentPage(prevPageNumber)}
                  disabled={prevPageNumber <= 0 || prevPageNumber > totalPages}
                  isCurrentPage={isCurrentPage}
                >
                  {prevPageNumber}
                </NumberButton>
              ); // Return nothing if data is still loading
            }
          })}
        </NumberContainer>
...
//               );
//             } else {
//                const prevPageNumber = currentPage - offset + i;
